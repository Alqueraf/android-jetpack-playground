...
class DataItemsRepositoryUnitTest : KoinTest {

    private val dataItemsRepository by inject<DataItemsRepository>()
    ...
    fun getsItemsFromApi() = runBlockingTest {
        // Result
        val result = dataItemsRepository.getItems(refresh = false)
    ...
    fun getItemFromApi() = runBlockingTest {
        // Result
        val result = dataItemsRepository.getItem(6873175)
        assert(result is Success)
        // Items
